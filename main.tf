...
module "automation_account" {
  ...
  schedules         = lookup(each.value, "schedules", {
    "weekdays 7am" = {
      ...
      start_time    = "2021-07-19T07:00:00Z" # annoyingly this needs to be 5 mins ahead of the first deployment and the time that you want the job to run
    },
    "weekdays 7pm" = {
      week_days     = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
      start_time    = "2021-07-16T19:00:00Z"
    }
  })
